...
module.exports = function (log, error) {
  ...
  // TODO
  var ACCOUNT_WEB_SESSIONS = 'CALL accountWebSessions_1(?)'

  MySql.prototype.accountWebSessions = function (uid) {
    return this.readOneFromFirstResult(ACCOUNT_WEB_SESSIONS, [uid])
  }
