...
module.exports = function (log, error) {
  ...
  Memory.prototype.createVerificationReminder = function (request) {
  ...
  Memory.prototype.fetchReminders = function (request) {
    var self = this
  ...
  Memory.prototype.deleteReminder = function (request) {
    var reminderData = request.body
    delete reminders[reminderData.uid.toString('hex') + reminderData.type]
